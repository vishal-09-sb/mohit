...
public class MovieServiceTest {
    ...
    @Test
    void testSaveTicket() {
        Ticket expectedTicket = new Ticket("Ram","The Matrix", "Screen 1", 2, new ArrayList<String>(List.of("a1","a2")));
    ...
    void testGetAllBookedTickets() {
        ...
        List<Ticket> expectedTickets = Arrays.asList(
                new Ticket("Ram","The Matrix", "Screen 1", 2, new ArrayList<String>(List.of("a1","a2")))
        );
